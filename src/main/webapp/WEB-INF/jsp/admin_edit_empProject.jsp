...
<div id="formId">
<form  action="${pageContext.request.contextPath}/admin/updateEmployeeProject" method="post" data-toggle="validator" role="form"  id="sky-form" class="sky-form" >
						...
						<div class="col-md-6">
	            			<div class="form-group">
								<label class="col-sm-5 control-label">ID</label>
									<div class="col-sm-7">
	    								<input type="text" id="id" name="id" value="${employeeProject.empProjectId }"   required="required"  readonly/>
						...
						<div class="col-md-6">
	            			<div class="form-group">
								<label class="col-sm-5 control-label">Employee Name</label>
									<div class="col-sm-7">
	    								<input type="text" id="empName" name="empName" value="${employeeProject.employee.firstName }"   required="required" onclick="return empSelect();" readonly/>
	     									<div id="empId"></div>
	     									<div class="help-block with-errors"></div>
	     									<span id="err"> </span>
	     							</div>
						...
						<div class="col-md-6">
            				<div class="form-group">
								<label class="col-sm-5 control-label">Employee ID</label>
									<div class="col-sm-7">
    									<input type="text" name="employeeId" id="employeeId" value="${employeeProject.employee.id }"   required="required"  readonly/>
						...
						<div class="col-md-6">
            				<div class="form-group">
								<label class="col-sm-5 control-label">Project Name</label>
									<div class="col-sm-7">
    									<input type="text" name="projectName" id="projectName" value="${employeeProject.project.projectName }"   required="required" onclick="return projectSelect();" readonly/>
     										<div id="projectId"></div>
     										<div class="help-block with-errors"></div>
     										<span id="err"> </span>
     								</div>
  						...
  						<div class="col-md-6">
            				<div class="form-group">
								<label class="col-sm-5 control-label">Project ID</label>
									<div class="col-sm-7">
    									<input type="text" name="projectIDD" id="projectIDD" value="${employeeProject.project.projectId }"   required="required" readonly />
     										<!-- <div id="projectId"></div> -->
     										<div class="help-block with-errors"></div>
     										<span id="err"> </span>
     								</div>
