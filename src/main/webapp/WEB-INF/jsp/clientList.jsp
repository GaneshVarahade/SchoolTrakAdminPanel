...
<button  class="open-AddBookDialog btn btn-primary" data-toggle="modal"  data-id=""  data-target="#forClientRegistration">Add Client</button>
<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
        ...
        <c:forEach var="client" items="${clientList}">
            <tr>
  					<td>
          				  <input type="checkbox" id="${client.clientId}"  name="myTextEditBox" value="" onClick="displayNote(event)"/>
          			</td>
				      			...
				      			<div class="modal-content">
				        			...
				        			<div class="modal-body">
											...
											<div class="col-md-6">
												...
												<div class="form-group col-lg-4">
													<label>Client Username</label>
													<input type="text" name="cclientUsername" id="cclientUsername" value="" class="form-control"  onkeypress="return AllowAlphabet(event);"   onblur="checkUsernameUpdate();">
												</div>
												
												<div class="form-group col-lg-4">
													<label>Client Password</label>
													<input type="text" name="cclientPassword" id="cclientPassword" value="" class="form-control"    onblur="password_length_registration();">
												</div>
												
												<div class="form-group col-lg-4">
													<label>Client Name</label>
													<input type="text" name="cclientName" id="cclientName" value="" class="form-control"  onkeypress="return AllowAlphabet(event);" >
												</div>
												
												<div class="form-group col-lg-4">
													<label>email</label>
													<input type="text" name="cclientEmail" id="cclientEmail" value="" class="form-control" onblur="emailValidateUpdate">
												</div>
												
												<div class="form-group col-lg-4">
													<label>Mobile No</label>
													<input type="text" name="cclientMobile" id="cclientMobile" value="" class="form-control" onblur="return phoneValidRegistration(cclientMobile);">
												</div>
												
												<div class="form-group col-lg-4">
													<label>Address</label>
													<input type="text" name="cclientAddress" id="cclientAddress" value="" class="form-control" onkeypress="return AllowAlphabet(event);">
												</div>
				        			...
				        			<div class="modal-footer">
				          				<button type="button" class="btn btn-default" onclick="sendDataForRegistration();" data-dismiss="modal">Close</button>
				        			</div>
				      			</div>
				    	</div>
				  </div>
